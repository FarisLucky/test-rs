        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="main-card mb-3 card col-md-8">
                    <div class="card-header">List Penyakit
                    ...
                    <div class="table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-inline">
                                                <a href="{{ route('penyakit.edit', $item->id_penyakit) }}" class="mr-2">
                                                ...
                                                <form action="{{ route('penyakit.destroy', $item->id_penyakit) }}" method="post">
                                                    @csrf
                                                    @method('delete')
                        ...
                        {{$penyakit->appends(Request::all())->links('vendor.pagination.custom')}}
                    </div>
                </div>
                </div>
            </div>
